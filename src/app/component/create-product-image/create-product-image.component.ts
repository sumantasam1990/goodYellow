...
export class CreateProductImageComponent implements OnInit {
  ...
  url: string = 'https://administrator.goodyellowco.com/api/u/vendor/create/product/photo?token='
  dataUrl: string = 'https://administrator.goodyellowco.com/api/u/vendor/get/product/photos/'
  deleteUrl: string = 'https://administrator.goodyellowco.com/api/u/vendor/edit/product/photo/delete/'
